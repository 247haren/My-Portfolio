    ...
    return(
        <nav className="navbar flex">
            ...
            <div className="box flex-center buttons">
                ...
                <a href='https://drive.google.com/file/d/103tQjiMI7nU6h5HGCaQCJDAhudr7A0NF/view?usp=sharing' target='_blank' rel='noopener noreferrer'  className='btn services-btn'>Resume</a>
